...
# Uložím do proměnné prvek, která budu chtít přidat
...
# Zde efektivně pracujeme s tím, že do parametru appande() dáváme proměnnou, do které uživatel uložít hodnotu,
...
# Zde efektivně pracujeme i s proměnnou, kterou zadá uživatel, uživatel rozhoduje, který prvek se odrstraní
